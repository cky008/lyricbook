...
> **0.0.6 基于 0.0.5 引入的现代技术栈，新增旧版歌词迁移、亮暗模式、列表交互优化和小册封面。** 项目使用 React 19.2.8、React DOM 19.2.8、Vite 8.2.2、TypeScript 7.0.2、Tailwind CSS 4.3.3、Rust 1.98.0、Vitest 4.1.11 和 Playwright 1.62.1；不再包含 React 16、本地 vendor React 或 `window.React` 兼容层。
